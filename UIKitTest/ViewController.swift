...
class ViewController: UIViewController {
    ...
    func setupViews(){
        ...
        let bottomRightLabel = makeLabel(withText: "bottomRight")
        view.addSubview(upperRightLabel)
        view.addSubview(upperLeftLabel)
        view.addSubview(bottomRightLabel)
        view.addSubview(bottomLeftLabel)
        
        let loginButton = makeButton(withText: "Login Button")
        ...
        NSLayoutConstraint.activate([
            ...
            bottomRightLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -8),
